...
public interface ItineraryItemRepository extends JpaRepository<ItineraryItem, Long> {
    ...
    Optional<ItineraryItem> findTopByItineraryIdOrderByItemOrderDesc(Long itineraryId);
    boolean existsByItineraryAndDestination(Itinerary itinerary, Destination destination);
}
